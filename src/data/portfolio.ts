...
export const TESTIMONIALS = [
  ...
  { quote: "Aye Board transformed our classrooms. Teachers love it, students engage more — a genuine leap forward for our school.", name: "Ramesh Varma", title: "Principal, Sunrise Public School", rating: 5 },
  { quote: "ScholAR Labs made science tangible. Our Class 9 students now understand concepts that used to take weeks to teach.", name: "Anitha R.", title: "Science HOD", rating: 5 },
  { quote: "Their AI CCTV system flagged incidents in real time. Campus safety has measurably improved since deployment.", name: "Capt. Vishal Rao", title: "Head of Security, Tech Campus", rating: 5 },
  { quote: "Energy monitoring across three phases gave us full visibility — we cut anomalies by 40% in the first quarter.", name: "Suresh Babu", title: "Plant Manager, Spectra Industries", rating: 5 },
  { quote: "Ask.VisionariesAI saves our teachers hours every week on question papers and evaluations. Brilliant product.", name: "Lakshmi Devi", title: "Academic Director", rating: 5 },
  { quote: "Srikanth and his team are world-class. Clear thinking, fast shipping, and an obsession with quality.", name: "Karthik Reddy", title: "Co-founder, ByteForge", rating: 5 },
  { quote: "The LMS handles our entire school operations end-to-end. Parents, teachers, admins — everyone is finally on one page.", name: "Madhavi Naidu", title: "Trustee, Vidya Vikas Schools", rating: 5 },
  { quote: "Our attendance system with face + RFID has been rock solid for over a year. Zero downtime.", name: "Imran Khan", title: "Operations Lead", rating: 5 },
  { quote: "From a rough idea to a polished product — they delivered with grace, on time, and beyond expectation.", name: "Pooja Sharma", title: "Founder, Lumenly", rating: 5 },
  { quote: "Honestly the most thoughtful engineering team we've worked with. They care about the small things.", name: "Arvind Iyer", title: "CTO, Northwind Labs", rating: 5 },
  { quote: "Visionicx and NEXT-GEN under Srikanth's leadership are building the kind of products India needs.", name: "Dr. Meena Joshi", title: "EdTech Researcher", rating: 5 },
  { quote: "Fantastic UI/UX work. Our conversion rate went up by 32% after their redesign and new flows.", name: "Vikas Menon", title: "Growth Lead, Finstack", rating: 5 },
];
